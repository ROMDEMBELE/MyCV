...
fun DiabetesType.displayIcon(context: Context): Drawable? {
    return when (this) {
        DiabetesType.TYPE_1 -> ContextCompat.getDrawable(context, R.drawable.ic_diabetes_type_one)
        DiabetesType.TYPE_2 -> ContextCompat.getDrawable(context, R.drawable.ic_diabetes_type_two)
    }
}
